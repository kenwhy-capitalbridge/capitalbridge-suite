...
/** Primary headings (cover, major sections) — Tinos for PDF/print alignment; serif fallback for web */
export const REPORT_FONT_DISPLAY = '"Tinos", "Roboto Serif", Georgia, "Noto Serif", ui-serif, serif';
