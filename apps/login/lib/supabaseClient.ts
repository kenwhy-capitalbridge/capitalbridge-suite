...
import { createAppBrowserClient, createRecoveryBrowserClient, isSupabaseConfigured } from "@cb/supabase/browser";
...
export const recoverySupabase = createRecoveryBrowserClient();
