...
export const SummaryAtGlance: React.FC<SummaryAtGlanceProps> = ({ kpis, currency }) => (
  <div className="grid grid-cols-2 gap-3 sm:gap-4">
    <div className="rounded-xl border border-[#FFCC6A]/25 bg-[#0D3A1D]/80 p-3 sm:p-4">
    ...
    <div className="flex items-center rounded-xl border border-[#FFCC6A]/25 bg-[#0D3A1D]/80 p-3 sm:p-4 min-h-[52px]">
      <SustainabilityBadge
